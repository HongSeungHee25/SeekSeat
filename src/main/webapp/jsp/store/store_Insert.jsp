...
<body>
   ...
   <section>
      ...
      <br>
      <form action="registerStoreInfo?type=2" method="post" enctype="multipart/form-data">
         <table>
         <tr>
            ...
            <tr>
               ...
               <td><input type="text" id="storeName" name="name"></td>
            </tr>
            <tr>
               <th><label for="phone">전화번호</label></th>
               <td><input id="phone" name="store_tel" type="text" size="11"
                  maxlength="13" oninput="formatPhone()"></td>
            </tr>
            <tr>
               <th><label for="adr">주소</label></th>
               <td><input type="text" id="adr" name="address"></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td><input id="cdays" name="closedDays" type="text"></td>
            </tr>
            <tr>
               <th><label for="introduce">매장 소개글</label></th>
               <td><input type="text" id="introduce" name="content" ></td>
            </tr>
            <tr>
               <th><label for="picture1">메인 사진</label></th>
               <td><input type="file" id="picture1" name="mainPictureUrl" ></td>
            </tr>
            <tr>
               <th><label for="picture2">매장 사진</label></th>
               <td><input type="file" id="picture2" name="pictureUrl" ></td>
            </tr>
            <tr>
               <th><label for="picture3">메뉴판 사진</label></th>
               <td><input type="file" id="picture3" name="menuPictureUrl" ></td>
            </tr>   
            <tr>
               <th><label for="hashtag">매장 해시태그</label></th>
               <td><textarea id="hashtag" name="hashtag"></textarea></td>
            </tr>
         </table>
